...
how the user  should to compile the program?.
 we create 2 files:
1. matrix.h 2. matrix.cpp and (readme). 
...
how the user  should to compile the program?.
 we create 2 files that contains a file for the statements "matrix.h", a file for the functions realization "matrix.cpp" and a  The files need to be copied to Visual Studio. 
